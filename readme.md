...
---
first and foremost before diving in deep you should  have your own vector representation in my code it will be found in *header/vector.h* or click here [vector header](https://github.com/yorkings/refactored_graphical_ray_tracing/header/vector.h).
